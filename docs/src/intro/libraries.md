...
หมายเหตุ: การเรียกเหล่านี้_ต้อง_ไม่มีผลข้างเคียงที่จำเป็นต้องคงอยู่ไปจนถึงการทำงานเชิงพลวัต
...
_ในการเขียนไบต์โค้ดใหม่_ เราฝัง `wasmtime` ไว้เพื่อเรียกไลบรารีดังกล่าว ขณะที่แบ็กเอนด์ท่องไปตามไบต์โค้ดของแอปพลิเคชันเป้าหมาย
