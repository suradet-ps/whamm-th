...
หากตัวแปรถูกทำเครื่องหมายเป็น `unshared` อินสแตนซ์ของตัวแปรนี้จะถูกสร้างให้*ทุกจุดที่แมตช์*ของโพรบ
สโคปของตัวแปรนี้จำกัดอยู่ที่*จุดที่แมตช์*นั้นๆ
ค่าของตัวแปรนี้จะคงที่ในทุกครั้งที่เข้าไปในตรรกะของโพรบ นั่นหมายความว่ามันจะไม่ถูกเริ่มต้นใหม่ทุกครั้ง

คุณจึงใช้ตัวแปรนี้เก็บข้อมูล ณ จุดหนึ่งของโปรแกรม*เมื่อเวลาผ่านไป*ได้
