...
หากตัวแปรถูกทำเครื่องหมายเป็น `shared` อินสแตนซ์เดียวของตัวแปรนี้จะถูกใช้ร่วมกันโดย_ทุกจุดที่แมตช์_ของโพรบ
สโคปของตัวแปรนี้จำกัดอยู่ที่_ทุกจุดที่แมตช์_ของโพรบ
ค่าของตัวแปรนี้จะคงที่ในทุกครั้งที่เข้าไปในตรรกะของโพรบ หมายความว่ามันจะไม่ถูกเริ่มต้นใหม่ทุกครั้ง

ใช้เก็บข้อมูลสำหรับอีเวนต์ที่โพรบ_เมื่อเวลาผ่านไป_ได้
