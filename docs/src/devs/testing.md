...
เพื่อยืนยันว่า_แอสเซอร์ชันทั้งหมด**ล้มเหลว**ก่อนทำ instrumentation_ ไฟล์ `.wast` ใหม่ 5 ไฟล์จะถูกสร้างขึ้นด้วยโมดูลต้นฉบับและรันบนอินเทอร์พรีเตอร์ที่กำหนดค่าไว้
และเพื่อยืนยันว่า_แอสเซอร์ชันทั้งหมด**ผ่าน**หลังทำ instrumentation_ ไฟล์ `.wast` ใหม่ 2 ไฟล์จะถูกสร้างขึ้น หนึ่งไฟล์ต่อสคริปต์ `whamm` ที่ระบุ โดยรวมแอสเซอร์ชันไว้ใต้สคริปต์ `whamm` ที่เกี่ยวข้อง
